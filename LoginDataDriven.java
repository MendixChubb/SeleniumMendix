	...
	public static void main(String[] args) throws AWTException, InterruptedException, BiffException, IOException
	{
		// TODO Auto-generated method stub
			...
			String Producingcountry,Branch,Countryofinsured,Effectivedate,Currency,Chubbriskmanagement,Direct;
 			...
 			String Ann_Open,AccClause,PctOfLimit,CyberClause,RadClause,SancClause,TermClause,CodeDesc,Selection,Amt,Limit,Deduct,WordSource,StowageType;
        ...
        WebDriverWait waitLog =new WebDriverWait(driver,10);
        ...
        // assertEquals("Marine Risk Overview" , driver.getTitle());
         ...
         WebElement dynamic = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='mx-grid-toolbar']//*[@id='uniqName_11_1']")));
        		
         driver.findElement(By.xpath("//div[@class='mx-grid-toolbar']//*[@id='uniqName_11_1']")).click();
         //Thread.sleep(5000);
         WebDriverWait waitRisk =new WebDriverWait(driver,20);
         ...
         //WebElement myDynamic = (new WebDriverWait(driver, 20)).until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[text()='Insured Name *']//following::td[2]//input")));
       ...
       System.out.println(Multinationalpolicy);
       System.out.println(FAC);
         ...
         driver.findElement(By.xpath("//*[text()='Policy Effective Date *']//following::td[2]//div/div/input")).sendKeys(Effectivedate);	
          ...
          WebElement myDynamicElement = (new WebDriverWait(driver, 20)).until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[text()='Annual/Open Cover or Single Shipment *']//following::td[2]//select")));
		...
		driver.findElement(By.xpath("//*[text()='Number of years of claims history *']//following::div[@class='mx-name-textBox1']/input")).sendKeys(NoOfYears);
		action.sendKeys(Keys.TAB).build().perform();
		Thread.sleep(1000);
        ...
        Thread.sleep(5000);
       // WebDriverWait waitClaims =new WebDriverWait(driver,20);
       // WebElement dynamicClaims = waitClaims.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[text()='Number of years of claims history *']//following::div[@class='mx-name-textBox1']/inpu")));
        
        driver.findElement(By.xpath("//*[text()='Next']")).click();
	
		
		//Storage screen
        WebDriverWait waitStore =new WebDriverWait(driver,20);
        WebElement dynamicStore = waitStore.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[text()='All Risks excl CAT']//following::td[1]/div/select")));
        ...
        driver.findElement(By.xpath("//*[text()='FAC RI Premium *']//following::td[2]//input")).sendKeys(FacPrem);
        
        driver.findElement(By.xpath("//*[text()='Policy Number']//following::td[2]//input")).sendKeys(PolNo);//Policy Number
